...
class TestBlockingClient(unittest.TestCase):
    ...
    def test_get_top_players(self):
        ...
        '''
        self.assertEqual(self.clashroyale_client.get_top_players().raw_data, dict)

    def test_get_popular_players(self):
        '''This test will test out:
        - Popular players endpoint
        '''
        self.assertEqual(self.clashroyale_client.get_popular_players().raw_data, dict)
    ...
    def test_get_tracking_clans(self):
        ...
        '''
        self.assertEqual(self.clashroyale_client.get_tracking_clans(), list)

    def test_get_top_clans(self):
        '''This test will test out:
        - Top clans endpoint
        '''
        self.assertEqual(self.clashroyale_client.get_top_clans().raw_data, dict)

    def test_get_popular_clans(self):
        '''This test will test out:
        - Popular clans endpoint
        '''
        self.assertEqual(self.clashroyale_client.get_popular_clans().raw_data, dict)
    ...
    def test_get_known_tournaments(self):
        ...
        '''
        self.assertEqual(isinstance(self.clashroyale_client.get_known_tournaments()), list)

    def test_get_open_tournaments(self):
        '''This test will test out:
        - Open tournaments endpoint
        '''
        self.assertEqual(isinstance(self.clashroyale_client.get_open_tournaments()), list)

    def test_get_popular_tournaments(self):
        '''This test will test out:
        - Popular tournaments endpoint
        '''
        self.assertEqual(self.clashroyale_client.get_popular_tournaments().raw_data, dict)
    ...
    def test_get_popular_decks(self):
        ...
        '''
        self.assertEqual(self.clashroyale_client.get_popular_decks().raw_data, dict)
